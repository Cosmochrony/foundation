...
the moment of resolution.
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{lll}
      ...
      \\
      \midrule
      Irreversibility & Non-injectivity (A2) & Proved (Prop.~\ref{prop:irreversibility}) \\
      Structural fluctuations & Relational residue $\Delta_n$ & Derived
      \\
      Temporal order & Irreversibility + novelty (A2) & Proved (Thm.~\ref{thm:temporal-order}) \\
      Proto-state (wave) & Unresolved multiplicity (A1, A3) & Derived (Prop.~\ref{prop:indeterminacy}) \\
      ...
      \\
      Discrete transitions & Projection locking (A4, O22) & Proved (Thm.~\ref{thm:discrete-locking}) \\
      ...
      \\
      Bell non-applicability & Temporal, non-local, non-independent fibre & Proved~\cite{Beau2026b}
      \\
      Phase coherence $\Rightarrow$ QM & Admissibility + O-series & Proved~\cite{Beau2026q1}
      \\
      Born rule (SU(2) sector) & Correlator + coherence (Q1) & Proved~\cite{Beau2026q1}
      \\
      ...
      \\
      $\mathrm{SU}(2)$ gauge structure &
      Quaternionic rigidity (O27, O30)~\cite{Beau2026a31,Beau2026a34} & Proved \\
      Tower of non-injectivity &
      ENI Corollary~6~\cite{Beau2026l} & Proved \\
      \midrule
      $\mathrm{SU}(3)$ gauge structure &
      Colour triplet co-admissibility (O31)~\cite{Beau2026a35} & Conditional on $[\mathrm{H\text{-}color}]$ \\
      \midrule
      Full Hilbert structure & Beyond SU(2) parity sector & \textbf{Open}
      \\
      Born rule (general) & Beyond SU(2) parity sector & \textbf{Open}
      \\
      Colour charges, quark sector & Individual sectors $c_i$ (O31, O32) & \textbf{Open}
      \\
      \bottomrule
    \end{tabular}
