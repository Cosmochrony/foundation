...
the moment of resolution.
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{p{5.2cm}p{5.8cm}p{3.2cm}}
      ...
      Proved \\
      Entanglement &
      Shared non-factorisable ancestral fibre &
      Derived \\
      ...
      Proved \\
      \midrule
      \multicolumn{3}{l}{\textit{Conditional on named hypothesis}} \\
      \midrule
      $G_{\mathrm{SM}} =
      \mathrm{SU}(3)\times\mathrm{SU}(2)\times\mathrm{U}(1)$ &
      Colour co-admissibility (O31, O32)~\cite{Beau2026a35} &
      Proved for $\mathcal{S}_q$ (O31, Prop.~4.23~\cite{Beau2026a35}) \\
      \midrule
