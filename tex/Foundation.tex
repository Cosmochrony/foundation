...
the moment of resolution.
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{p{5.2cm}p{5.8cm}p{3.2cm}}
      ...
      Conditional on $[\mathrm{H\text{-}color}]$ \\
      \midrule
  ...
  \subsection*{Partial spectral stratification: an organising pattern from the companion programme}
    ...
    \begin{remark}
      ...
      remains conditional on~$[\mathrm{H\text{-}color}]$~\cite{Beau2026a35,Beau2026a36},
      the Lorentzian continuation of the spectral functional remains an open step,
      and the fermionic entry is a structural prediction, not a derived result.
  ...
  \subsection*{Open directions}
    ...
    \paragraph{O31/O32 --- Colour sector and recursive non-injectivity.}
      ...
      Under Hypothesis~$[\mathrm{H\text{-}color}]$ (triplet co-admissibility,
      numerically supported in O32~\cite{Beau2026a36}),
